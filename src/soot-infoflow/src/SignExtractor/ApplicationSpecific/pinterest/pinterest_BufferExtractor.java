...
public abstract class pinterest_BufferExtractor
{
...
//			if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: com.android.volley.Request get(java.lang.String,com.pinterest.api.BaseApiResponseHandler,boolean,boolean,boolean,java.util.Map,java.lang.String)>")) {
...
//			if(sm.getSignature().equals("<com.pinterest.activity.conversation.ConversationFragment$10: void onSuccess(com.pinterest.api.ApiResponse)>")) {
//				System.out.println("111");
//			}else if(sm.getSignature().equals("<com.pinterest.activity.conversation.ConversationFragment: void access$1800(com.pinterest.activity.conversation.ConversationFragment)>")) {
//				System.out.println("222");
//			}else if(sm.getSignature().equals("<com.pinterest.activity.conversation.ConversationFragment: void loadConversationMessages()>")) {
//				System.out.println("333");
//			}else if(sm.getSignature().equals("<com.pinterest.api.remote.ConversationApi: void g(java.lang.String,com.pinterest.api.BaseApiResponseHandler,java.lang.String)>")) {
//				System.out.println("444");
//			}else if(sm.getSignature().equals("<com.pinterest.api.remote.BaseApi: void a(java.lang.String,com.pinterest.api.RequestParams,com.pinterest.api.BaseApiResponseHandler,java.lang.String)>")) {
//				System.out.println("555");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: com.android.volley.Request get(java.lang.String,com.pinterest.api.RequestParams,com.pinterest.api.BaseApiResponseHandler,java.lang.String)>")) {
//				System.out.println("666");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: com.android.volley.Request get(java.lang.String,com.pinterest.api.RequestParams,com.pinterest.api.BaseApiResponseHandler,boolean,java.util.Map,java.lang.String)>")) {
//				System.out.println("777");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: com.android.volley.Request get(java.lang.String,com.pinterest.api.BaseApiResponseHandler,boolean,boolean,boolean,java.util.Map,java.lang.String)>")) {
//				System.out.println("888");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: void addToRequestQueue(com.android.volley.Request,java.lang.String)>")) {
//				System.out.println("999");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient$1: void <init>(java.lang.String,com.android.volley.Response$Listener,com.android.volley.Response$ErrorListener,com.android.volley.Response$HeaderListener,boolean,java.lang.String,java.util.Map)>")) {
//				System.out.println("1010");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient$1: void <init>(java.lang.String,com.android.volley.Response$Listener,com.android.volley.Response$ErrorListener,com.android.volley.Response$HeaderListener,boolean,java.lang.String,java.util.Map)>")) {
//				System.out.println("11");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteVxApiUrl(java.lang.String)>")) {
//				System.out.println("1212");
//			}else if(sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteApiUrl(java.lang.String)>")) {
//				System.out.println("1313");
//			}else if(sm.getSignature().equals("")) {
...
//			}
			...
			//			if(sm.getSignature().equals("<in.shick.pinterest.mail.InboxListActivity$DownloadMessagesTask: java.lang.Void doInBackground(java.lang.Integer[])>")) {
...
//		if (sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: void addToRequestQueue(com.android.volley.Request,java.lang.String)>"))
//		{
//		if (sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: com.android.volley.Request get(java.lang.String,com.pinterest.api.BaseApiResponseHandler,boolean,boolean,boolean,java.util.Map,java.lang.String)>"))
//		{
//		if (sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteVxApiUrl(java.lang.String)>"))
//		{
//		if (sm.getSignature().equals("<com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteApiUrl(java.lang.String)>"))
//		{
//			System.out.println();
...
//				if(ut.toString().equals("virtualinvoke $r2.<com.android.volley.RequestQueue: com.android.volley.Request add(com.android.volley.Request)>($r0)")) {
//					int a = 10;
//					a = a+1;
//				}
//			}
...
//								pinterest_HeapHandler.updateHeapTableWithSootValue(LeftSootValue, RightSootValue);
							}
							// if $v.<> = constant
							else if (as.getRightOp() instanceof Constant)
							{
//								pinterest_HeapHandler.updateHeapTable(LeftSootValue, as.getRightOp().toString());
							}
							// if $v.<> = $v
							else if (BFTtable.get(as.getRightOp().toString()) != null)
							{
								...
								pinterest_HeapHandler.updateHeapTable(LeftSootValue, GenRegex(null, BFTtable, var));
							}
							// if $v.<> = new or ...
							// do nothing
							else
							{
								pinterest_HeapHandler.updateHeapTable(LeftSootValue, as.getLeftOp().getType().equals("java.lang.Integer") ? "[0-9]*" : "(.*)");
							}
						} else
						{
			...
			else if (ut instanceof ReturnStmt)
			{
				...
				if (isUrlpath)
				{
					...
					} else
					{
						...
						BackwardRtnValueStack.removeLast();
//						System.out.println("Add Last : " + GenRegex(null, BFTtable, variable));
...
//						if(ut.toString().contains("staticinvoke <com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteApiUrl(java.lang.String)>($r0)")) {
...
//						}
						...
						if(ut.toString().contains("$r1 = virtualinvoke $r1.<java.lang.String: java.lang.String replaceFirst(java.lang.S")) {
...
//							System.out.println("@parameter0 : " + ForwardRtnParameterTableStack.getLast().get("@parameter0"));
			...
			if (SootMethodSet.size() > 0)
			{
				if (strDest != null)
				{
					// for pinterest, bug occured.
					// 20160107 hnamkoong
					// ----Normal case ---
					// $r4 = staticinvoke <com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteVxApiUrl(java.lang.String)>($r0);
					// ---- Exceptional case --- 
					// $r1 is needed when ExtractingExpr, but it overrieds the value here. 
					// $r1 = virtualinvoke $r1.<java.lang.String: java.lang.String replaceFirst(java.lang.String,java.lang.String)>("v3", "vx")
					
					// temporarry case handle
					if(ut.toString().equals("$r4 = staticinvoke <com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteApiUrl(java.lang.String)>($r0)") ||
							ut.toString().equals("$r4 = staticinvoke <com.pinterest.api.ApiHttpClient: java.lang.String getAbsoluteVxApiUrl(java.lang.String)>($r0)")) {
