...
package Extractocol.BufferExtractor_Request.Semantic.JSON;
...
import Extractocol.BufferExtractor_Request.Basics.EquvNode;
...
public class JSONBuilder extends SignatureBuilder_Request
{
	...
	@Override
	public String AnalyzeExpression(InstanceInvokeExpr iie, HashMap<String, ArrayList<BFNode>> BFTtable, Unit ut, SootMethod sootMethod, String strDst)
			throws NodeNotFoundException
	{
	...
	private void readValuefuncHandler(InstanceInvokeExpr iie, HashMap<String, ArrayList<BFNode>> bFTtable, Unit ut, SootMethod sootMethod)
	{
		...
		if (!result.equals(""))
		{
			...
			if (dpentry == null)
			{
				dpentry = new PairingDPEntry(Constants.EPcont.getDP(), Constants.EPcont.getDPStmt(), result, null);
