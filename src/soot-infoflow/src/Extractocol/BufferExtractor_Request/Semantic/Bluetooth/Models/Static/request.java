...
public class request extends BaseModel {
	...
	public void applySemantic(SemanticParameterBucket spb) {
		if (spb.sie.getMethodRef().toString()
				.equals("<com.logitech.harmonyhub.sdk.imp.BluetoothManager: org.json.JSONObject request(java.lang.String,long)>") 
				|| spb.sie.getMethodRef().toString()
				.equals("<com.logitech.harmonyhub.sdk.imp.BluetoothManager: org.json.JSONObject request(java.lang.String)>"))
		{
			System.out.println("Request!! : " + printUrlFromList(spb.BFTtable, spb.sie.getArgs().get(0).toString()));
		}
	}
