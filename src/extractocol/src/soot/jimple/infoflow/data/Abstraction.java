 ...
 */
public class Abstraction extends AbstractionExtension implements Cloneable, FastSolverLinkedNode<Abstraction, Unit>,
		LinkedNode<Abstraction> { /** 'AbstractExtension' was added by BK. */
