...
public class BFNode implements Cloneable
{
	...
	private static boolean ListCompare(ArrayList<String> s1, ArrayList<String> s2){
		if(s1 == null && s2 == null)
			return true;
	...
	public boolean isSameWith(BFNode bfn){
		return StringCompare(this.stringForUrl, bfn.stringForUrl);
	}
