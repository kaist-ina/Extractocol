...
/**
 * SourceSinkManager for Android applications. This class uses precise access path-based source and
 * sink definitions.
 * 
 * @author Steven Arzt
 *
...
public class AccessPathBasedSourceSinkManager extends AndroidSourceSinkManager
{
	...
	/**
	 * Creates a new instance of the {@link AndroidSourceSinkManager} class with either strong or
	 * weak matching.
	 * 
	 * @param sources
	 ...
	 *            The list of callback methods whose parameters are sources through which the
	 *            application receives data from the operating system
	 * @param weakMatching
	 *            True for weak matching: If an entry in the list has no return type, it matches
	 *            arbitrary return types if the rest of the method signature is compatible. False
	 *            for strong matching: The method signature in the code exactly match the one in the
	 *            list.
	 * @param layoutMatching
	 *            Specifies whether and how to use Android layout components as sources for the
	 ...
	 * @return True if the given access path matches the given definition, otherwise false
	 */
