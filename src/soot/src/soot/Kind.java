...
public final class Kind implements Numberable
{
    ...
    /** [Extractocol]  Due to call to Volley methods */
    public static final Kind VOLLEY_INIT_GETHEADERS = new Kind ("VOLLEY_GETHEADERS");
    public static final Kind VOLLEY_RESPONSE = new Kind ("VOLLEY_RESPONSE");
