...
public class Printer {
    ...
    /* Added by BK */
    public void printTo(SootClass cl, PrintWriter out){ printTo(cl, out, true); }

    public void printTo(SootClass cl, PrintWriter out, boolean isJimple /* Added by BK */) {
                ...
                while (methodIt.hasNext()) {
                    ...
                    if (!Modifier.isAbstract(method.getModifiers())
                        ...
                        if (!method.hasActiveBody()){
                        	...
                        	if(isJimple) /* Added by BK */
                        		printTo(method.getActiveBody(), out);
                        	else
                        		printTo(Shimple.v().newBody(method.getActiveBody()), out);
