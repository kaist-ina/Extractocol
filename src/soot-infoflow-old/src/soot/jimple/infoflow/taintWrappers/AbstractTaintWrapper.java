...
public abstract class AbstractTaintWrapper implements ITaintPropagationWrapper {
	...
	public abstract Set<AccessPath> getTaintsForMethodInternal2(Stmt stmt, AccessPath taintedPath);
	...
	@Override
	public Set<Abstraction> getTaintsForMethod2(Stmt stmt, Abstraction d1,
			Abstraction taintedPath) {
		// Compute the tainted access paths
		Set<AccessPath> aps = getTaintsForMethodInternal2(stmt,
				taintedPath.getAccessPath());
		if (aps == null || aps.isEmpty())
			return null;
